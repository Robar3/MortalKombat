...
async function init() {
    ...
    const enemyJSON = await fetch('https://reactmarathon-api.herokuapp.com/api/mk/player/choose').then(res => res.json());
    ...
    players.forEach(item => {
        ...
        el.addEventListener('click', () => {
           ...
           console.log(localStorage.setItem('enemy', JSON.stringify(enemyJSON)) );
